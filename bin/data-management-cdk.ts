...
for (const stage of stages) {
  ...
  const ingestion = new DataMgmtIngestionStack(app, `${stage.stageName}-DataMgmtIngestionStack`, { stage });
  const processing = new DataMgmtProcessingStack(app, `${stage.stageName}-DataMgmtProcessingStack`, {
    stage,
