...
export class DataMgmtApiStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: DataMgmtApiStackProps) {
    ...
    this.api = new apigwv2.HttpApi(this, 'HttpApi', {
      corsPreflight: {
        allowOrigins: ['*'],
        allowMethods: [apigwv2.CorsHttpMethod.GET, apigwv2.CorsHttpMethod.POST, apigwv2.CorsHttpMethod.PATCH, apigwv2.CorsHttpMethod.PUT, apigwv2.CorsHttpMethod.DELETE],
        allowHeaders: ['Authorization', 'Content-Type'],
      },
    });

    const authorizer = new apigwv2Auth.HttpJwtAuthorizer('CognitoAuthorizer', props.userPool.userPoolProviderUrl, {
    ...
    const classificationsLambda = new lambda.NodejsFunction(this, 'ClassificationsLambda', {
      ...
      runtime: lambdaBase.Runtime.NODEJS_20_X,
      timeout: cdk.Duration.seconds(30),
      environment: { CLASSIFICATION_TABLE: props.classificationConfigTable.tableName },
    });
