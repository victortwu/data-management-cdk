...
function detectFileType(key: string): string {
...
async function processEmail(fileBytes: Buffer, originalKey: string) {
...
async function extractTextWithTextract(fileBytes: Buffer): Promise<string> {
...
function buildTags(documentType: string, entities: { organizations: string[]; dates: string[] }): string[] {
  const tags: string[] = [];
...
function textToPdfBytes(text: string): Buffer {
...
async function saveMetadata(record: DocumentRecord) {
